...
getDynLibDir  = catchIO (getEnv "DesktopEntry_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "DesktopEntry_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "DesktopEntry_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "DesktopEntry_sysconfdir") (\_ -> return sysconfdir)
