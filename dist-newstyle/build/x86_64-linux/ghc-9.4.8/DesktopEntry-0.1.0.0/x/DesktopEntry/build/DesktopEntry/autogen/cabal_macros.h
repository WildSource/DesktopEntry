...
/* package DesktopEntry-0.1.0.0 */
#ifndef VERSION_DesktopEntry
#define VERSION_DesktopEntry "0.1.0.0"
#endif /* VERSION_DesktopEntry */
#ifndef MIN_VERSION_DesktopEntry
#define MIN_VERSION_DesktopEntry(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_DesktopEntry */
...
#define CURRENT_COMPONENT_ID "DesktopEntry-0.1.0.0-inplace-DesktopEntry"
